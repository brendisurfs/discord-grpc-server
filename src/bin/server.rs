mod common;
use common::requestor::DreamPost;
...
/// TODO: should I be passing in the http context instead?
async fn send_prompt_to_generator(prompt: String) -> Result<(), Box<dyn Error>> {
